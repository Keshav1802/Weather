  ...
  Future<dynamic> getLocationData() async {
    ...
    if (weatherData != null && serviceEnabled) {
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (BuildContext context) => new HomeScreen(weatherDataJson: weatherData),),
      ...
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (BuildContext context) => new LocationError(),),
              (Route<dynamic> route) => false
      );
      // Get.to(
      //   () => LocationError(),
